...
public class WebServiceAutuacao {
	...
	public final String[] get(String url) {
		...
		try {
			...
			if (entity == null) {
				...
				instream.close();
				Log.d("post", "Resultado do post JSONPost: " + result[0] + ": " + result[1]);
			}
		} catch (Exception e) {
			Log.e("NGVL", "Falha ao acessar o Webservice");
			result[0] = "0";
	...
	public final String[] post(String url, String json) {
		...
		try {
			...
			if (entity == null) {
				...
				result[1] = toString(instream);
				instream.close();
				Log.d("post", "Resultado de posto JSONPost: " + result[0] + ": " + result[1]);
			}
		} catch (Exception e) {
			Log.e("NGVL", "Falha ao acessar o Webservice");
			result[0] = "0";
